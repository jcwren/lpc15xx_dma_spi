...
#if !defined(DEBUG_SEMIHOSTING)
int WRITEFUNC(int iFileHandle __attribute__ ((unused)), char *pcBuffer, int iLength);
int WRITEFUNC(int iFileHandle __attribute__ ((unused)), char *pcBuffer, int iLength)
{
#if defined(DEBUG_ENABLE)
	int i;
 ...
 * of bytes received */
int READFUNC(int iFileHandle __attribute__ ((unused)), char *pcBuffer, int iLength);
int READFUNC(int iFileHandle __attribute__ ((unused)), char *pcBuffer, int iLength)
{
	int idx;
