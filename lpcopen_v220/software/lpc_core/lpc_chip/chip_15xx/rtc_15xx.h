 ...
 * @return	None
 */
STATIC INLINE void Chip_RTC_Init(LPC_RTC_T *pRTC __attribute__ ((unused)))
{
 ...
 * @return	None
 */
STATIC INLINE void Chip_RTC_DeInit(LPC_RTC_T *pRTC __attribute__ ((unused)))
{
 ...
 */
STATIC INLINE uint32_t Chip_RTC_ClearStatus(LPC_RTC_T *pRTC, uint32_t stsMask __attribute__ ((unused)))
{
	return pRTC->CTRL;
}
