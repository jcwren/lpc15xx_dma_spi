...
void Chip_PMU_SleepState(LPC_PMU_T *pPMU __attribute__ ((unused)))
{
...
void Chip_PMU_DeepSleepState(LPC_PMU_T *pPMU __attribute__ ((unused)))
{
	Chip_PMU_ClearSleepFlags(LPC_PMU, PMU_PCON_SLEEPFLAG | PMU_PCON_DPDFLAG);
...
void Chip_PMU_PowerDownState(LPC_PMU_T *pPMU __attribute__ ((unused)))
{
	Chip_PMU_ClearSleepFlags(LPC_PMU, PMU_PCON_SLEEPFLAG | PMU_PCON_DPDFLAG);
	SCB->SCR |= (1UL << SCB_SCR_SLEEPDEEP_Pos);
