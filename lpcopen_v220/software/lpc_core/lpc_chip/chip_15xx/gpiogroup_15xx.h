 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_GPIOGP_Init(LPC_GPIOGROUPINT_T *pGPIO __attribute__ ((unused)))
{
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_GPIOGP_DeInit(LPC_GPIOGROUPINT_T *pGPIO __attribute__ ((unused)))
{
