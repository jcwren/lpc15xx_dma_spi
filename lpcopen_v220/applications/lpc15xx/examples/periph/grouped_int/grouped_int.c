...
/* GPIO pin for GROUPED GPIO interrupt.  This is the center button of the
   joystick. */
#define TEST_BUTTON_PIN         10	/* GPIO pin number mapped to PININT */
#define TEST_BUTTON_PORT        2	/* GPIO port number mapped to PININT */
